...
- **Tối ưu AI tutor hiện có** — mining chatlog để tìm chỗ tutor đang làm chưa tốt, chọn một chỗ và làm cho tử tế.
...
- **Tối ưu**: nhận diện intent thật (chào hỏi / hỏi bài / hỏi logistics) và trả lời đúng cỡ · biết-mình-không-biết + chuyển TA thay vì đoán · trả lời logistics (deadline, link, nộp bài) chỉ từ nguồn chính thức — trả sai deadline là gây hại thật.
...
Chatlog VLearn tutor × học viên đã ẩn danh (xem `data/vlearn-pack/`) · transcript bài giảng và log Trợ lý Học viên (bổ sung vào `data/` trước sự kiện) · quyền xem Discord khoá. **Cả lớp là user thật** — khảo sát 20 người là chuyện một giờ nghỉ.
...
| 4 | Lát cắt prototype được | Một câu chuẩn trên, demo được 5 phút, build nổi trong thời gian sự kiện |
