...
| Điều kiện | Điểm |
|---|---|
| Golden set ≥20 case nhóm tự xây: ≥2 case/lớp chỗ khó + 8-10 case thường + 2-4 case hiếm; ≥10 case từ chatlog thật | 5 |
| Mỗi chiều chất lượng có định nghĩa kiểm chứng được (người ngoài nhóm chấm ra cùng kết quả) | 5 |
| Quality bar bằng con số, nằm trong spec.md commit trước 23:59 N1, giữ nguyên sau đó | 4 |
| Bảng kết quả chạy trọn bộ ≥1 lượt, đủ mọi case kể cả case chưa đạt, có %, đối chiếu quality bar; chưa đạt thì có phân tích nguyên nhân | 6 |
...
## PHẦN 2 — CHECKLIST XÁC MINH 6 MỐC *(TA xác minh theo đúng các ô dưới đây, 2 phút mỗi nhóm)*
